...
Se declaran funciones pero no se tiene muy claro que es lo que se tiene
que hacer primero, se genera la funcion correctamente con los parametros de entrada
que serian el array la string a comparar, luego se crea un ciclo donde se compara
la longitud de ambos parametros y al ser elementos que llamaremos del DOM se crean
funciones adicionales para elementos ul y elementos li, 
despues de eso se pierde la logica.
No se termino el ejercicio por tratar de verificar la forma de imprimir